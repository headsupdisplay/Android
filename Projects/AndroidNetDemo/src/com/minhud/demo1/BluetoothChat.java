...
public class BluetoothChat extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		timer.schedule(new TimerTask()
		{
			...
			public void run()
			{
				String response = Net.getServerDirection();
				if (!response.equals(""))
				{
					if (response.equals("right"))
					{
						sendMessage(Operations.setPeripheralColor((byte)3, (byte)255, (byte)255, (byte)0));
					...
					else if (response.equals("backwards"))
					{
						sendMessage(Operations.setPeripheralColor((byte)3, (byte)255, (byte)0, (byte)0));
						sendMessage(Operations.turnPeripheralOn((byte) 3));
						Log.v(TAG, "backwards");
					}
				}
